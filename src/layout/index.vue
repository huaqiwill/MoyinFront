        ...
        <el-row>
          ...
          <el-col :span="6">
            <div class="text-editor-group">
              <p>
                <ElButton type="primary" plain>生成配音</ElButton>
              </p>
              <p>
              ...
              <p>
                <ElButton type="primary" plain>一键清空</ElButton>
              </p>
              <p>
          ...
          >
            ...
            >
              <div v-show="item.name == activeTab" class="flex">
                <div
                  v-for="(dub, index) in item.dubList"
                  :key="dub.title"
...
// import EditableDiv from "../EditableDiv/EditableDiv.vue";
