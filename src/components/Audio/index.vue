    ...
    <el-card class="box-card" shadow="hover">
        ...
        <div class="audio-container">
            ...
            <div style="display: flex;align-items: center;">
                <div class="controls">
                    <el-button type="primary" @click="playAudio" v-if="!isPlaying">{{ isPlayingText }}</el-button>
                    <el-button type="primary" @click="pauseAudio" v-if="isPlaying">{{ isPlayingText }}</el-button>
                </div>
                <div class="time-display">
                    {{ formatTime(currentTime) }} / {{ formatTime(duration) }}
                </div>
            </div>
            <el-slider v-model="currentTime" :max="duration" @input="onSliderChange"></el-slider>
