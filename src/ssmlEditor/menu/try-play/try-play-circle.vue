...
const boxRef = ref();
const dragContainerBoxRef = inject("dragContainerBox");
const editorViewBoxBounds = useElementBounding(dragContainerBoxRef);
const playButtonRef = ref();
const recordClientX = ref(0);
const recordClientY = ref(0);
...
function isPlayButtonClick(event) {
